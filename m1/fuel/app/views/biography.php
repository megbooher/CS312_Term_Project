...
<section id="team_biographies">
    <div class="team_left_pos">
            ...
            <div id="AR_Photo">
                <?php echo Asset::img('AR_Photo.jpg', array('style' => 'width: 150px', 'alt' => 'photo of Andrew Ricciardi'));?>
            </div>
            <p>
    ...
    <div class="team_right_pos">
        ...
        <div class="floatClear"></div>
        <div id="JN_Photo">
            <?php echo Asset::img('JN_Photo.jpg', array('style' => 'width: 150px', 'alt' => 'photo of Andrew Ricciardi'));?>
        </div>
        <p>
    ...
    <div class="team_left_pos">
        ...
        <div class="floatClear"></div>
        <div id="MF_Photo">
            <?php echo Asset::img('MF_Photo.jpg', array('style' => 'width: 150px', 'alt' => 'photo of Andrew Ricciardi'));?>
        </div>
        <p>
    ...
    <div class="team_right_pos">
        ...
        <div class="floatClear"></div>
        <div id="MB_Photo">
            <?php echo Asset::img('MB_Photo.jpg', array('style' => 'width: 150px', 'alt' => 'photo of Andrew Ricciardi'));?>
